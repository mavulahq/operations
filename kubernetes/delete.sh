...
kubectl delete -f "$BASE_DIR/service-identity-access.yaml" --ignore-not-found
...
kubectl delete -f "$BASE_DIR/deployment-identity-access.yaml" --ignore-not-found
...
kubectl delete -f "$BASE_DIR/identity-access-secret.yaml" --ignore-not-found
